...
define('GOOGLE_API_KEY', 'AIzaSyChKW-E1WqI0C4GQvr4qspsoo_rZcEqlUo');//Replace with your Key
...
<h1>Google Cloud Messaging</h1>
    <form method = 'POST' action = ''>
        <div>
            <textarea rows = 4  name = "message" cols = 50 placeholder = 'Type your message...'></textarea>
        </div>
